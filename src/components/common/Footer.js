            ...
            <Grid container>
              <Grid item md={6} sm={6} className="p-10">
                ...
                >
                  ...
                  data to execute these transactions. Ecommerce is often used to
                  refer to the sale of physical products online, but it can also
              ...
              <Grid item md={4} sm={10} xs={12} className="p-10">
                <div className="p-10 border-bottom">
                  ...
                  >
                    ...
                    nutrition graduate student at Framingham State. She loves
                    all things digital, learning about nutrition, running,
