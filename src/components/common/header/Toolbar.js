...
import { cartQuantity, trimText } from '../../../helpers/Util';
            ...
            <Toolbar>
              ...
              <div className={classes.search}>
                ...
                <InputBase
                  ...
                  inputProps={{
                    type: 'search',
                    'aria-label': 'search by press enter...',
                  }}
                ...
                <MenuItem onClick={this.handleClick}>
                  <Typography variant="body1" className={classes.title}>
                    ...
                    Object.keys(this.props.authData).length > 0 ? (
                      <span>Hi {trimText(this.props.authData.name, 10)}</span>
                    ) : (
                      'Account'
                    )}
                  </Typography>
...
const mapStateToProps = (state) => {
  return {
    numberCart: cartQuantity(state.carts.Carts || []),
