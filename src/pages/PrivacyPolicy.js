    ...
    return (
      <>
        <Container style={{ marginTop: "100px" }}>
          <div>
            <h2 className="text-align-center p-10">
              <strong>Privacy Policy</strong>
            </h2>

            <Typography variant="body1" className="p-10">
              <strong>
                <em>Updated June 14, 2020</em>
              </strong>
            </Typography>
            ...
            <Typography variant="body1" className="p-10">
              ...
              describes how EGadgets Internet Private Limited and its affiliates
              (collectively “EGadgets, we, our, us”) collect, use, share or
              otherwise process your personal information through EGadgets
              website <a href="http://www.EGadgets.com">www.EGadgets.com</a>,
            ...
            <Typography variant="body1" className="p-10">
              ...
              any product/service under this Platform outside India. By visiting
              ...
              <a href="https://www.EGadgets.com/pages/terms">Terms of Use</a>{" "}
            ...
            <Typography variant="body1" className="p-10">
              ...
              browse the Platform without telling us who you are or revealing
              any personal information about yourself. Once you give us your
              personal information, you are not anonymous to us. Where possible,
            ...
            <Typography variant="body1" className="p-10">
              We collect personal information (such as email address, delivery
              ...
              transact with us. While you can browse some sections of our
              Platform without being a registered member, certain activities
              (such as placing an order or consuming our online content or
              services) do require registration. We do use your contact
            ...
            <Typography variant="body1" className="p-10">
              ...
              or other message areas or leave feedback or if you use voice
              commands to shop on the Platform, we will collect that information
              you provide to us. We retain this information as necessary to
              resolve disputes, provide customer support and troubleshoot
            ...
            <Typography variant="body1" className="p-10">
              If you enrol into our SuperCoins Loyalty Program, we will collect
              and store your personal information such as name, contact number,
              ...
              provided by you to EGadgets or a third-party business partner that
              operates online/offline establishments or platforms where you can
              earn SuperCoins for purchase of goods and services, and redeem
              SuperCoins. We will also collect your information related to your
              transactions on EGadgets platform and such third-party business
              partner platforms. When such third-party business partner collects
              your personal information directly from you, you will be governed
              by their privacy policies. EGadgets shall not be responsible for
              the third-party business partner’s privacy practices or the
              content of their privacy policies, and we request you to read
              their privacy policies prior to disclosing any information.
            </Typography>
            <Typography variant="body1" className="p-10">
              EGadgets has onboarded certain third-party business partners on
              the Platform who specialise in the categories like travel ticket
              ...
              websites/applications will be based on your EGadgets login
              credentials after seeking your permissions to share the data
              further. EGadgets shall not be responsible for the Ultra-Partner’s
            ...
            <Typography variant="body1" className="p-10">
              ...
              opt-out of such uses. We use your personal information to assist
            ...
            <Typography variant="body1" className="p-10">
              With your consent, we will have access to your SMS, contacts in
              your directory, location and device information. We may also
              request you to provide your PAN, GST Number, Government issued ID
              cards/number and Know-Your-Customer (KYC) details to: (i) check
              your eligibility for certain products and services including but
              not limited to credit and payment products; (ii) issue GST invoice
              for the products and services purchased for your business
              ...
              us, sellers, affiliates or lending partners. You understand that
            ...
            <Typography variant="body1" className="p-10">
              ...
              offerings, we and our affiliates collect and analyse demographic
            ...
            <Typography variant="body1" className="p-10">
              ...
              you may choose to provide. The surveys may involve collection of
              voice data or video recordings, the participation of which would
              ...
              think you might be interested in and to display content according
              to your preferences.
            </Typography>
            <Typography variant="body1" className="p-10">
            ...
            <Typography variant="body1" className="p-10">
              ...
              a session. You are always free to decline/delete our cookies if
              your browser permits, although in that case you may not be able to
              use certain features on the Platform and you may be required to
              ...
              marketing and analytical purposes. Google Analytics help us
            ...
            <Typography variant="body1" className="p-10">
              ...
              services offered by them, such as, the deferred payment options
              EGadgets PayLater offered by EGadgets Advanz Private Limited
            ...
            <Typography variant="body1" className="p-10">
              ...
              as sellers, business partners. This disclosure may be required for
              us to provide you access to our products and services; for
              fulfilment of your orders; for enhancing your experience; for
              ...
              and advertising activities; to analyse data; for customer service
            ...
            <Typography variant="body1" className="p-10">
              Our Platform may provide links to other websites or application
            ...
            <Typography variant="body1" className="p-10">
              <strong>7. Choice/Opt-Out</strong>
            </Typography>
            <Typography variant="body1" className="p-10">
              ...
              <a href="https://www.EGadgets.com/communication-preferences/email">
                https://www.EGadgets.com/communication-preferences/email
              </a>
              ] to unsubscribe/opt-out.
            </Typography>
            <Typography variant="body1" className="p-10">
              <strong>8. Advertisements on Platform</strong>
            </Typography>
            <Typography variant="body1" className="p-10">
            ...
            <Typography variant="body1" className="p-10">
              <strong>9. Children Information</strong>
            </Typography>
            <Typography variant="body1" className="p-10">
              ...
              then you must use the Platform, application or services under the
            ...
            <Typography variant="body1" className="p-10">
              ...
              partners and other third parties) to contact you through SMS,
            ...
            <Typography variant="body1" className="p-10">
              Email:{" "}
              <a href="mailto:grievance.officer@EGadgets.com">
                grievance.officer@EGadgets.com
              </a>
            </Typography>
            <Typography variant="body1" className="p-10">
            ...
            <Typography variant="body1" className="p-10">
              Customer Support: You can reach our customer support team to
              address any of your queries or complaints by clicking the link,
              selecting your order and choosing 'Need Help' option:{" "}
              <a href="https://www.EGadgets.com/helpcentre">
                https://www.EGadgets.com/helpcentre
              </a>
            </Typography>
            <Typography variant="body1" className="p-10">
              <strong>14. Queries</strong>{" "}
            </Typography>
            <Typography variant="body1" className="p-10">
              ...
              <a href="mailto:membercare@payback.in">at</a> the contact
