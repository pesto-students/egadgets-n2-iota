          ...
          <div className="text-justify">
            <div>
              ...
              <Typography variant="body1" className="p-10">
                ...
                contracting with EGadgets Internet Private Limited and these
                terms and conditions including the policies constitute Your
                binding obligations, with EGadgets.
              </Typography>
              <Typography variant="body1" className="p-10">
                ...
                buyer on the Platform by providing Registration Data while
                registering on the Platform as Registered User using the
                computer systems. EGadgets allows the User to surf the Platform
                or making purchases without registering on the Platform. The
                term <strong>"We", "Us", "Our"</strong> shall mean EGadgets
              ...
              <Typography variant="body1" className="p-10">
                ...
                also accept and agree to be bound by EGadgets Policies
